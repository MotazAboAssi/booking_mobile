class TenantKeys {
  ...
  static const String favoriteEmptyMessage = 'tenant.favorite_view.empty_state.message';

  // Booking View
  static const String bookingPageTitle = 'tenant.booking_view.page_title';
  static const String bookingTabCurrent = 'tenant.booking_view.tabs.current';
  ...
  // Bottom Navigation
  static const String navSearch = 'tenant.bottom_nav.search';
  static const String navWishlist = 'tenant.bottom_nav.wishlist';
  static const String navBooking = 'tenant.bottom_nav.booking';
  static const String navAccount = 'tenant.bottom_nav.account';
  ...
  static const String detailBarPriceSuffix = 'tenant.apartment_detail.booking_bar.per_month';
  static const String detailBarRequestButton = 'tenant.apartment_detail.booking_bar.request_button';

  // Filter View
  static const String filterTitle = 'tenant.filter_view.title';
  static const String filterCityLabel = 'tenant.filter_view.city.label';
  static const String filterCityPlaceholder = 'tenant.filter_view.city.placeholder';
  static const String filterPriceLabel = 'tenant.filter_view.price';
