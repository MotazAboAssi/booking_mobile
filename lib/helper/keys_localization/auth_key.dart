class AuthKeys {
  // Login View
  static const String loginTitlePage = 'auth.login_view.title_page';
  static const String loginTextGuide = 'auth.login_view.text_guide';
  static const String loginInputPhoneLabel = 'auth.login_view.input_phone.label';
  static const String loginErrorInputPhone = 'auth.login_view.input_phone.error_text';
  static const String loginInputPasswordLabel = 'auth.login_view.input_password.label';
  static const String loginErrorInputPassword = 'auth.login_view.input_password.error_text';
  static const String loginButtonSubmit = 'auth.login_view.button_submit';
  static const String loginFooterQuestion = 'auth.login_view.footer.question';
  static const String loginFooterActionLink = 'auth.login_view.footer.action_link';

  // Role Selection View
  static const String roleHeaderTitle = 'auth.role_selection_view.header_title';
  static const String roleSubHeader = 'auth.role_selection_view.sub_header';
  static const String roleTenantName = 'auth.role_selection_view.options.tenant.role';
  static const String roleTenantDesc = 'auth.role_selection_view.options.tenant.description';
  static const String roleLandlordName = 'auth.role_selection_view.options.landlord.role';
  static const String roleLandlordDesc = 'auth.role_selection_view.options.landlord.description';
  static const String roleFooterQuestion = 'auth.role_selection_view.footer.question';
...
static const String pickCamera = 'auth.register_view.pick_image.camera';
  ...
  static const String logoutButtonDiscard = 'auth.logout.buttons.discard';
}